...
const HomeHero = () => {
  ...
  return (
    <section 
      className='pt-[81px] min-h-screen relative overflow-hidden flex flex-col justify-between'
    >
      <div
      ...
      <div className='pt-40 lg:pt-24 flex-grow'>
      ...
      {/* Overlay background */}
      <div className='absolute top-0 left-0 z-10 h-full bg-opacity-5 bg-[#333ba5] w-full'></div>

      {/* Splide Section */}
      <div className='w-full relative z-30 py-16 flex items-center px-8 curved-inward'>
        <Splide
          options={{
            resetProgress: false,
            rewind: true,
