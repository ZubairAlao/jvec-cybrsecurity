...
import JvecPioneeringImgOptimized from "@/assets/images/jvec-pioneering-optimized.webp"
...
const JvecPioneering = () => {
  return (
    <section className="pages-vertical-padding relative overflow-hidden">
      ...
      ></div>
        <div className="container z-20 relative space-y-12 lg:space-y-0 text-center lg:text-right lg:flex flex-row-reverse gap-12 items-start">
            <div className="space-y-6 mx-auto lg:w-1/2">
                <h1 className="heading-font-sizes font-bold">JVEC - Pioneering Excellence in ICT Solution</h1>
                <p>
