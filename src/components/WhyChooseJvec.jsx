  ...
  return (
    <div className='mt-[56px] md:mt[72px] lg:mt-[150px]'>
      <div className='container'>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 auto-rows-max gap-6 mt-[40px] lg:mt-[80px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 auto-rows-max gap-6 md:mt-[107px] mt-[40px]">
          {WhyChooseJvecListTwo.map((reason, index) => (
            ...
            >
              {index === 1 ? (
                <div className='flex flex-1 text-2xl md:text-3xl lg:text-5xl flex-col text-center md:text-left'>
                  <h3>{reason.title}</h3>
                  <p>{reason.text}</p>
                </div>
              ) : (
