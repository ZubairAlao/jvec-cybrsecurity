    ...
    <section className='relative pages-vertical-padding overflow-hidden space-y-14'>
        <div className='flex md:flex-row-reverse flex-col justify-center lg:gap-32 gap-8'>
            <div className='container space-y-7 text-center md:text-right'>
                <h1 className='heading-font-sizes leading-9'>Take Action with JVEC Solutions’ Penetration Testing Services</h1>
            ...
            <div className='flex justify-center items-center mx-auto'>
                <div className='bg-[#111111] w-full flex justify-center items-center py-12 px-4'>
                    <div className='bg-[#282828] w-full flex flex-col justify-center items-center'>
                        <div className='text-center space-y-7 flex flex-col justify-center items-center p-9'>
                            <h3 className='text-2xl md:text-4xl lg:text-5xl'>Ready to Fortify Your Security? Schedule Your Free Consultation</h3>
                            <p className="text-sm lg:text-lg">Let JVEC Solutions give you the peace of mind that comes with world-class cybersecurity.</p>
